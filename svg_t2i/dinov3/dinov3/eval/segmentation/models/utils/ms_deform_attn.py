...
# Compatible import for custom_fwd and custom_bwd
try:
    # For PyTorch newer versions (e.g., 2.4+)
    from torch.amp import custom_fwd, custom_bwd
except ImportError:
    try:
        # For older PyTorch versions where it was in CUDA AMP
        from torch.cuda.amp import custom_fwd, custom_bwd
    except ImportError:
        # Fallback to autograd if applicable, though this is less common
        from torch.autograd import custom_fwd, custom_bwd
